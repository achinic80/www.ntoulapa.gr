...
document.addEventListener("DOMContentLoaded", function () {
    const vw_gardening_landscaping_progressBar =
        document.getElementById("vw_gardening_landscaping_elemento_progress_bar");
    if (!vw_gardening_landscaping_progressBar) return;
    window.addEventListener("scroll", function () {
        const vw_gardening_landscaping_scrollTop =
            document.documentElement.scrollTop || document.body.scrollTop;
        const vw_gardening_landscaping_height =
            document.documentElement.scrollHeight -
            document.documentElement.clientHeight;
        const vw_gardening_landscaping_scrolled =
            (vw_gardening_landscaping_scrollTop / vw_gardening_landscaping_height) * 100;
        vw_gardening_landscaping_progressBar.style.width =
            vw_gardening_landscaping_scrolled + "%";
    });
});