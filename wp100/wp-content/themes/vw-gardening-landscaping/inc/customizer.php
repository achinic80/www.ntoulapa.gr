...
function vw_gardening_landscaping_customize_register( $wp_customize ) {
  ...
  $wp_customize->add_control('vw_gardening_landscaping_footer_template',array(
   ...
   $wp_customize->add_setting('vw_gardening_landscaping_footer_social_icons_font_size',array(
	...
	$wp_customize->add_setting( 'vw_gardening_landscaping_web_frame',array(
		'default' => 0,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_gardening_landscaping_switch_sanitization'
    ) );
    $wp_customize->add_control( new vw_gardening_landscaping_Toggle_Switch_Custom_Control( $wp_customize, 'vw_gardening_landscaping_web_frame',array(
		'label' => esc_html__( 'Show / Hide Blog Page Border','vw-gardening-landscaping' ),
		'section' => 'vw_gardening_landscaping_post_settings'
    )));

	$wp_customize->add_setting('vw_gardening_landscaping_web_frame_border_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'vw_gardening_landscaping_web_frame_border_color', array(
		'label'    => __('Blog Page Border Color', 'vw-gardening-landscaping'),
		'section'  => 'vw_gardening_landscaping_post_settings',
	)));

	$wp_customize->add_setting('vw_gardening_landscaping_web_frame_border_width',array(
		'default'=> '',
		'sanitize_callback' => 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_gardening_landscaping_web_frame_border_width',array(
		'label' => __('Blog Page Width','vw-gardening-landscaping'),
		'description' => __('Enter a value in pixels Example:20px','vw-gardening-landscaping'),
		'input_attrs' => array(
		'placeholder' => __( '10px', 'vw-gardening-landscaping' ),
	),
	...
	$wp_customize->add_setting('vw_gardening_landscaping_show_first_caps', array(
	    'default'           => false,
	    'transport'         => 'refresh',
	    'sanitize_callback' => 'vw_gardening_landscaping_switch_sanitization',
	));

	$wp_customize->add_control(new vw_gardening_landscaping_Toggle_Switch_Custom_Control(
	    $wp_customize,
	    'vw_gardening_landscaping_show_first_caps',
	    array(
	        'label'   => esc_html__('First Cap (First Capital Letter)', 'vw-gardening-landscaping'),
	        'section' => 'vw_gardening_landscaping_post_settings',
	    )
	));
    ...
    // Single Posts Category
	  ...
	  $wp_customize->add_setting('vw_gardening_landscaping_single_post_styling',array(
    'default' => 'Button',
    'transport' => 'refresh',
    'sanitize_callback' => 'vw_gardening_landscaping_sanitize_choices'
	));
	$wp_customize->add_control('vw_gardening_landscaping_single_post_styling',array(
	'description' => __('Change the styling of Category .','vw-gardening-landscaping'),
	'type' => 'select',
    'section' => 'vw_gardening_landscaping_single_blog_settings',
    'choices' => array(
        'Button' => __('Button','vw-gardening-landscaping'),
		'Underline' => __('Underline','vw-gardening-landscaping'),
		'Default' => __('Default','vw-gardening-landscaping'),
      ),
	) );
	...
	$wp_customize->add_setting(
		'vw_gardening_landscaping_featured_image_hover',
		array(
			'default'           => 'none',
			'sanitize_callback' => 'sanitize_text_field',
		)
	...
	$wp_customize->add_control(
		'vw_gardening_landscaping_featured_image_hover',
		array(
			'label'   => __( 'Featured Image Hover Effect', 'vw-gardening-landscaping' ),
			'section' => 'vw_gardening_landscaping_single_blog_settings',
			'type'    => 'select',
			'choices' => array(
				'none'      => __( 'None', 'vw-gardening-landscaping' ),
				'zoom-in'   => __( 'Zoom In', 'vw-gardening-landscaping' ),
				'zoom-out'  => __( 'Zoom Out', 'vw-gardening-landscaping' ),
				'scale'     => __( 'Scale', 'vw-gardening-landscaping' ),
				'grayscale' => __( 'Grayscale', 'vw-gardening-landscaping' ),
				'blur'      => __( 'Blur', 'vw-gardening-landscaping' ),
				'bright'    => __( 'Bright', 'vw-gardening-landscaping' ),
				'sepia'     => __( 'Sepia', 'vw-gardening-landscaping' ),
				'translate' => __( 'Translate', 'vw-gardening-landscaping' ),
			),
		)
	);
	...
	// Progress Bar
	$wp_customize->add_setting( 'vw_gardening_landscaping_progress_bar', array(
		'default'           => 0, 
		'transport'         => 'refresh',
		'sanitize_callback' => 'vw_gardening_landscaping_switch_sanitization',
	));
	...
	$wp_customize->add_control(
		new VW_Gardening_Landscaping_Toggle_Switch_Custom_Control(
			$wp_customize,
			'vw_gardening_landscaping_progress_bar',
			array(
				'label'   => esc_html__( 'Show / Hide Progress Bar', 'vw-gardening-landscaping' ),
				'section' => 'vw_gardening_landscaping_left_right',
			)
		)
	);
	...
	$wp_customize->add_setting( 'vw_gardening_landscaping_sticky_sidebar',array(
      'default' => 0,
      'transport' => 'refresh',
      'sanitize_callback' => 'vw_gardening_landscaping_switch_sanitization'
    ) );
    $wp_customize->add_control( new vw_gardening_landscaping_Toggle_Switch_Custom_Control( $wp_customize, 'vw_gardening_landscaping_sticky_sidebar',array(
      'label' => esc_html__( 'Show / Hide Sticky Sidebar','vw-gardening-landscaping' ),
      'section' => 'vw_gardening_landscaping_left_right'
    )));
