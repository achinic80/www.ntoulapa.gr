...
function vw_gardening_landscaping_activation_notice() {
	...
	$vw_gardening_landscaping_meta = get_option( 'vw_gardening_landscaping_admin_notice' );

	if (!$vw_gardening_landscaping_meta) {
		echo '<div id="vw-gardening-landscaping-welcome-notice" class="notice notice-success is-dismissible welcome-notice">';
		echo '<div class="notice-row">';
			echo '<div class="notice-text">';
				...
				echo '<span class="import-btn"><a href="'. esc_url( admin_url( 'admin.php?page=vw_gardening_landscaping_guide' ) ) .'" class="button button-primary">'. esc_html__( 'IMPORT DEMO', 'vw-gardening-landscaping' ) .'</a></span>';
				...
				echo '<span class="bundle-btn"><a href="'. esc_url( 'https://www.vwthemes.com/products/wp-theme-bundle' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'BUNDLE OF 400+ THEMES', 'vw-gardening-landscaping' ) .'</a></span>';
			echo '</div>';
...
function vw_gardening_landscaping_dismissed_notice() {
	update_option( 'vw_gardening_landscaping_admin_notice', true );
}
add_action( 'wp_ajax_vw_gardening_landscaping_dismissed_notice', 'vw_gardening_landscaping_dismissed_notice' );

//After Switch theme function
add_action('after_switch_theme', 'vw_gardening_landscaping_getstart_setup_options');
function vw_gardening_landscaping_getstart_setup_options () {
    update_option('vw_gardening_landscaping_admin_notice', false );
}
