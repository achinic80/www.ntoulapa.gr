...
<stb-header-sidemenu _ngcontent-nek-c170="" class="burger-menu ng-tns-c170-1 ng-star-inserted" _nghost-nek-c169=""
style="border:0px solid red; position:fixed;  z-index:2100; height:100%; "> 
        ...
        <div _ngcontent-nek-c169="" class="side-nav--content ng-star-inserted">
            <div _ngcontent-nek-c169="" class="side-nav--header"><a _ngcontent-nek-c169="" routerlink="/"
                ...
                <stb-icon-button _ngcontent-nek-c169="" classlist="_tertiary" iconheight="20" iconwidth="20"
                    ...
                    <button onclick="toggleDesktopMenu();" _ngcontent-nek-c159=""
            ...
            <div _ngcontent-nek-c169="" class="side-nav--info ng-star-inserted">
                ...
                <stb-template-button _ngcontent-nek-c169="" size="x-small" stbopenloginwithbankidcondition=""
                    class="side-nav--button" _nghost-nek-c139=""><button _ngcontent-nek-c139=""
                        class="_primary _x-small button" title="" type="button"><span _ngcontent-nek-c139=""
                            class="button-content"  onclick="clickFavoriteMaster();" style="cursor:pointer;"> ΕΓΓΡΑΦΗ
                            <!---->
                        </span></button></stb-template-button>
                        <img _ngcontent-nek-c169="" alt="" height="123" onclick="clickFavoriteMaster();" style="cursor:pointer;"
...
<?php } ?>   
        ...
        <!---->
        <div _ngcontent-nek-c169="" langswitcher="" class="side-nav--footer"><button _ngcontent-nek-c169=""
            ...
            <!----><button _ngcontent-nek-c169="" stbopenzendeskchat="" type="button" aria-label="live chat"
                class="side-nav--btn">
