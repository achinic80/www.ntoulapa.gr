<x-app-layout>
    ...
    <div id="printable-content">
        ...
        Ταξινόμηση με : 
        <a href='{{ route('meli.remains') }}?sort_by=surname'>Επώνυμο</a>&nbsp;|&nbsp;
        <a href='{{ route('meli.remains') }}?sort_by=cussupcode'>Κωδ.Μέλους</a>&nbsp;|&nbsp;
        <a href='{{ route('meli.remains') }}?sort_by=category'>Κατηγορία</a>&nbsp;|&nbsp;
        <a href='{{ route('meli.remains') }}?sort_by=remain'>Υπόλοιπο</a>
        <br>
